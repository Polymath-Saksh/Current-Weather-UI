    ...
    async function updateTime() {
        while (true) {
            ...
            if (hours > sunriseHour + 1 && hours < sunsetHour - 1) {
                document.body.style.backgroundImage = "{% static 'img/day.jpg'}";
            } else if (hours >= sunriseHour - 1 && hours <= sunriseHour + 1) {
                document.body.style.backgroundImage = "{% static 'img/sunrise.jpg'}";
            } else if (hours >= sunsetHour - 1 && hours <= sunsetHour + 1) {
                document.body.style.backgroundImage = "{% static 'img/sunset.jpg'}";
            } else {
                document.body.style.backgroundImage = "{% static 'img/night.jpeg'}";
            }
        }
    }
